...
for (let btn of buttons) {
	btn.onclick = function () {
		...
		let atr = this.getAttribute('data-info');
...
document.addEventListener('mousemove',function(e){
	...
	for ( let icon of icons ) {
		icon.onclick = function () {
			...
			let header_inner = this.getAttribute('data-number');
			...
			//	div.style = 'top: 100px; left: 800px;';
				...
				div.style = 'top: 100px; left: 125px;';
			}else if (header_inner == 63 && check == 1) {
				div.style = 'top: 100px; left: 125px;';
			} else if (header_inner == 64 && check == 1) {
				div.style = 'top: 100px; left: 125px;';
			} else if (header_inner == 65 && check == 1) {
				div.style = 'top: 100px; left: 125px;';
			}
